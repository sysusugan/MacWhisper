...
class AppState: ObservableObject {
    ...
    @Published var transcriptionLanguage: TranscriptionLanguage = .chinese
    ...
    init() {
        ...
        loadSettings()
        whisperRecognizer.preferredLanguage = transcriptionLanguage
        setupBindings()
    ...
    func loadSettings() {
        ...
        if let raw = defaults.string(forKey: StorageKeys.transcriptionLanguage),
    ...
    func saveSettings() {
        ...
        defaults.set(transcriptionLanguage.rawValue, forKey: StorageKeys.transcriptionLanguage)
